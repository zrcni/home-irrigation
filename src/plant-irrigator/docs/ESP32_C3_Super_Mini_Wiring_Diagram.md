# ESP32-C3 Super Mini Wiring Diagram

This diagram illustrates the complete wiring for the 3-plant irrigation system using the **ESP32-C3 Super Mini**, including power distribution, relay connections, flyback diode protection, and sensor connections.
...
graph TD
    ...
    subgraph Control_Unit [Control Unit]
        ...
        %% Control Signals
        ESP -->|GPIO 6| R1_IN[Relay IN1]
        ESP -->|GPIO 10| R2_IN[Relay IN2]
        ESP -->|GPIO 21| R3_IN[Relay IN3]
    end
    ...
    subgraph Plant_1 [Plant 1]
        ...
        %% Sensing Circuit
        ESP -->|GPIO 5 Power| SENS1
        SENS1 -->|GPIO 0 Data| ESP
        SENS1 -->|GND| USB_GND
    end
    ...
    subgraph Plant_2 [Plant 2]
        ...
        %% Sensing Circuit
        ESP -->|GPIO 7 Power| SENS2
        SENS2 -->|GPIO 1 Data| ESP
        SENS2 -->|GND| USB_GND
    end
    ...
    subgraph Plant_3 [Plant 3]
        ...
        %% Sensing Circuit
        ESP -->|GPIO 4 Power| SENS3
        SENS3 -->|GPIO 3 Data| ESP
        SENS3 -->|GND| USB_GND
    end
```
